...
\author{F.~M.~Y.~Fern\'{a}ndez,~\IEEEmembership{Student Member,~IEEE}
\thanks{The author is with the School of Engineering, Instituto Polit\'{e}cnico Nacional, Mexico.}
\thanks{Manuscript prepared for IEEE Systems Journal, 2026.}}

\markboth{Journal of \LaTeX\ Class Files,~Vol.~14, No.~8, August~2025}%
{Fern\'{a}ndez: CAMAE: Cognitive Adaptive Multicarrier Allocation Engine}
